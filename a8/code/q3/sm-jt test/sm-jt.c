...
int exec() {
  int cont = 1;
  int addr, val;
  void* jt[16] = {&&L0, &&L1, &&L2, &&L3, &&L4, &&DEFAULT, &&L6, &&L7, &&L8, \
...
void* jt_1[16] = {&&L0_1, &&L1_1, &&L2_1, &&L3_1, &&L4_1, &&L5_1, &&L6_1, &&L7_1, &&DEFAULT_1, \
                    &&DEFAULT_1, &&DEFAULT_1, &&DEFAULT_1, &&DEFAULT_1, &&DEFAULT_1, &&DEFAULT_1,\
                    &&LF_1};
